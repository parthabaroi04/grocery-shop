                        ...
                        <ul class="slides">
                            <li data-thumb="{{asset('/')}}/front/images/si.jpg">
                                <div class="thumb-image">
                                    <img src="{{asset('/')}}/front/images/si.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                            <li data-thumb="{{asset('/')}}/front/images/si2.jpg">
                                <div class="thumb-image">
                                    <img src="{{asset('/')}}/front/images/si2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                            <li data-thumb="{{asset('/')}}/front/images/si3.jpg">
                                <div class="thumb-image">
                                    <img src="{{asset('/')}}/front/images/si3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                            </li>
                        </ul>
