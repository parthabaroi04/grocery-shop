                ...
                <div class="deal-leftmk left-side">
                    ...
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{route('product-detail')}}">$18.00</a>
                        </div>
                    ...
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{route('product-detail')}}">$9.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            <h3>Tata Salt</h3>
                            <a href="{{route('product-detail')}}">$15.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{route('product-detail')}}">$525.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="special-sec1">
                        ...
                        <div class="col-xs-8 img-deal1">
                            ...
                            <a href="{{route('product-detail')}}">$149.00</a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
                ...
                <div class="wrapper">
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/m3.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                    ...
                    <div class="product-sec1 product-sec2">
                        ...
                        <div class="col-xs-5 bg-right-nut">
                            <img src="{{asset('/')}}/front/images/nut1.png" alt="">
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <!-- //second section (nuts special) -->
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk4.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="{{route('product-detail')}}" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk5.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk6.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                    ...
                    <div class="product-sec1">
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk7.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk8.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
                        ...
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset('/')}}/front/images/mk9.jpg" alt="">
                                    <div class="men-cart-pro">
                                        <div class="inner-men-cart-pro">
                                            <a href="single.html" class="link-product-add-cart">Quick View</a>
                                        </div>
